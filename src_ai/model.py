...
def rhys_model():
    """ Rhys Tyne's early draft of the AI model. """

    # TODO:  This can be ensured using requirements.txt
    # make sure keras is at version 3+
    # use pip install --upgrade keras
    # currently running using open AI gym breakout

    # TODO:  Modify for Shapez.ai
